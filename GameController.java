...
import demo.Game_0507;
import demo.Machine_0507;
...
public class GameController {
	...
	void init() {
		...
		machines.add(new Machine_0507("machine 0"));
		machines.add(new Machine_0507("machine 1"));
		machines.add(new Machine_0507("machine 2"));
		machines.add(new Machine_0507("machine 3"));
		machines.add(new Machine_0507("machine 4"));
		machines.add(new Machine_0507("machine 5"));
		machines.add(new Machine_0507("machine 6"));
